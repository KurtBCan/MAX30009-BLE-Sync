...
#define PLL_CONFIG_1 0x47 // for ~50kHz. 0x53for 22 hour test
#define PLL_CONFIG_2 0xFF
#define PLL_CONFIG_3 0x01
#define PLL_CONFIG_4 0x60 // (0x60 for EXT, 0x20 for internal)

#define BIOZ_CONFIG_1 0x75 // 0xF5 for 22 hour
